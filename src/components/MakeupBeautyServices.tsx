...
export const MakeupBeautyServices: React.FC<MakeupBeautyServicesProps> = ({ onSelectService }) => {
  ...
  return (
    <section id="makeup-services" className="py-20 lg:py-28 bg-[#f5f2eb] text-[#1a1a1a] relative border-b border-[#e2dacf]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 p-6 sm:p-8 bg-[#18181b] text-white rounded-2xl border border-[#d4af37]/40 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl">
