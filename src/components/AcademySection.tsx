  ...
  return (
    <section id="academy" className="py-20 lg:py-28 bg-[#faf7f2] text-[#191919] relative overflow-hidden border-b border-[#e5ded2]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Course Cards Grid (2-3 Featured or Full) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {displayedCourses.map((course) => (
            ...
            >
              {/* Image & Badges */}
              <div className="relative h-56 overflow-hidden bg-[#f0ede6]">
                <img 
                  src={course.image} 
                  alt={course.title}
              ...
              <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] uppercase tracking-wider px-2 py-0.5 bg-[#f5f1ea] text-[#996515] border border-[#dcd4c5] font-bold rounded">
                      {course.level}
                    </span>
                    <span className="text-[10px] uppercase tracking-wider text-[#6b6b66] font-medium">
                      • {course.schedule}
                    </span>
                  </div>
                ...
                <div className="pt-4 flex items-center gap-2">
                  <button
                    onClick={() => setSelectedCourseDetail(course)}
                    className="flex-1 py-2.5 text-xs font-semibold uppercase tracking-wider text-[#18181b] bg-[#f5f1ea] border border-[#dcd4c5] hover:border-[#18181b] hover:bg-white rounded-lg transition-all cursor-pointer"
                  >
                    View Details
                  </button>
                  ...
                  <button
                    onClick={() => onEnrollCourse(course)}
                    className="flex-1 py-2.5 text-xs font-bold uppercase tracking-[0.15em] text-[#050505] bg-[#d4af37] hover:bg-[#e5c358] transition-all flex items-center justify-center gap-1.5 cursor-pointer rounded-lg shadow-sm"
                  >
