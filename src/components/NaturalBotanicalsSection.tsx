...
export const NaturalBotanicalsSection: React.FC<NaturalBotanicalsSectionProps> = ({ 
  ...
  return (
    <section id="botanicals" className="py-20 lg:py-28 bg-[#050505] relative overflow-hidden">
      {/* Botanical Backdrop Ornaments */}
      <div className="absolute top-0 right-1/4 w-80 h-80 bg-[#d4af37]/4 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-10 left-1/4 w-80 h-80 bg-[#d4af37]/4 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif-luxury font-bold text-[#f5f5f0] tracking-tight">
            ...
            <span className="gold-gradient-text">Indigenous Ethiopian Super-Ingredients</span>
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {filteredList.map((item) => (
            <div
              ...
              className="group p-4 sm:p-5 bg-[#0e0e10] border border-white/10 hover:border-[#d4af37]/70 transition-all duration-300 cursor-pointer flex flex-col justify-between hover:-translate-y-1 shadow-lg"
            >
              <div>
                {/* Image & Badge */}
                <div className="relative h-36 sm:h-40 overflow-hidden mb-4 bg-[#080808]">
                  <img 
                    src={item.image} 
                    alt={item.name} 
                  ...
                  {item.badge && (
                    <span className="absolute top-2 right-2 bg-[#050505]/90 border border-[#d4af37]/60 text-[#d4af37] text-[9px] font-bold uppercase tracking-wider px-2 py-0.5 shadow-md">
                      {item.badge}
                    </span>
                  )}

                  {item.amharicName && (
                    <span className="absolute bottom-2 left-2 text-[11px] font-medium text-[#f5f5f0] bg-[#050505]/85 px-2 py-0.5 border border-[#d4af37]/30">
                      {item.amharicName}
                    </span>
                  )}
                </div>
                ...
                <div className="space-y-1">
                  <h3 className="font-serif-luxury font-bold text-sm sm:text-base text-[#f5f5f0] group-hover:text-[#d4af37] transition-colors">
                    {item.name}
                  </h3>
                  <p className="text-[11px] sm:text-xs text-[#a3a39e] line-clamp-2 leading-relaxed font-light">
                    {item.hairBenefit}
                  </p>
                </div>
              </div>
              ...
              {/* Bottom Action */}
              <div className="pt-3 mt-3 border-t border-white/10 flex items-center justify-between text-xs text-[#d4af37] font-semibold">
        ...
        <div className="mt-16 bg-[#0e0e10] border border-[#d4af37]/40 p-6 sm:p-10 shadow-2xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            
            <div className="lg:col-span-8 space-y-3">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#d4af37]/15 text-[11px] font-bold uppercase tracking-wider text-[#d4af37]">
            ...
            <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-3 justify-center">
              <button
                onClick={onOpenQuiz}
                className="px-6 py-3.5 font-bold text-xs uppercase tracking-[0.15em] text-[#050505] bg-[#d4af37] hover:bg-[#e5c358] shadow-xl flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <button
                ...
                className="px-6 py-3 font-semibold text-xs tracking-wider text-[#f5f5f0] bg-[#141416] border border-[#d4af37]/40 hover:bg-[#d4af37]/10 flex items-center justify-center gap-2 cursor-pointer uppercase"
              >
